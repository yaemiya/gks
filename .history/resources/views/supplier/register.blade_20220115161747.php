            ...
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <div>
                        ...
                        <x0input id="supplierName" class="block mt-1 w-full text-xs" type="text" :value="old('supplierName')"
                            ...
                            <tr class="tr">
                                <td class="registerTd">
                                    <select id="businessKind"
                                        class="pl-4 shadow-sm border-gray-300 block w-full text-xs"
                                ...
                                <td id="openSelectBox" class="td bg-white">
                                    <select id="plantList"
                                        class="pl-4 shadow-sm border-none block w-full text-xs"
