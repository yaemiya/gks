...
class AccountController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if(!$request->user_id)
        {
            Log::error('AccountController/update no $request->user_id error! auth user id='.Auth::user()->user_id.' user_id='.$user_id);
            return view('error');
        }
    ...
    public function destroy(Request $request)
    {
        ...
        if(!$user)
        {
            Log::error('AccountController/destroy User::find() error! auth user id='.Auth::user()->user_id.' user_id='.$user_id);
            return view('error');
        }
