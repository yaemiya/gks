        ...
        <div class="selectModalWrapper">
            <div class="modalContent w-auto">
                ...
                <div class="flex  mt-6 h-8">
                    ...
                    <input type="search" id="searchBox" class="searchBox" placeholder="キーワードを入力">
                </div>
                <divclass="border border-black">
                    <div class="text-center border-top border-black mt-8">店舗（ID）</div>
                    <div id="shopList" class="border border-black">
                        <ul class="divide-y divide-gray-200">
                            @foreach ($shops as $shop)
                                <li class="ml-5"><a href=#>{{ $shop->shop_name }}（{{ $shop->shop_id }}）</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
