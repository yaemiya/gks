...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        {
            Log::error($func . ':Supplier::create() error! auth user_id='.Auth::user()->user_id.' supplier_name='.$request->supplierName.' rep_name='.$request->repName.' address_id='.$request->building.' building='.$request->building);
            $message = __('messages.err.dbErr');
            DB::rollBack();
            return view('error', compact('message'));
        }
