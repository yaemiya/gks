                ...
                <form method="POST" action="store">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex">
                            ...
                            _1" class="block mt-1 mr-3 w-1/3 text-xs" type="text" :value="old('postal_code
                            _1')"
                                name="postal_code
                                _1" maxlength="5" placeholder="必須" />
                            _
                            <x-input id="postal_code
                            _2" class="block mt-1 mx-3 w-1/3 text-xs" type="text" :value="old('postal_code
                            _2')"
                                name="postal_code
                                _2" maxlength="5" placeholder="必須" />
                        </div>
                        <div id="postal_code
                        _err" class="text-sm text-red-600"></div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex">
                            ...
                            _
                            <x-input id="postal_code
                            _3" class="block mt-1 ml-3 w-1/3 text-xs" type="text" :value="old('postal_code
                            _3')"
                                name="postal_code
                                _3" maxlength="5" placeholder="必須" />
                        </div>
                        <div id="postal_code
                        _err" class="text-sm text-red-600"></div>
                    </div>
