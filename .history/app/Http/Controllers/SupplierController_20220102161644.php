...
class SupplierController extends Controller
{
    ...
    public function show($supplier_id)
    {
        ...
        if(!$supplier_id)
        {
            Log::error('SupplierController/show no supplier_id error! auth user id='.Auth::user()->user_id.' supplier_id='.$supplier_id);
            return view('error');
        }
        ...
        if(!$supplier)
        {
            Log::error('SupplierController/show find() error! auth user id='.Auth::user()->user_id.' supplier_id='.$supplier_id);
            return view('error');
        }
    ...
    public function edit($supplier_id)
    {
        ...
        if(!$supplier_id)
        {
            Log::error('SupplierController/edit no supplier_id error! auth user id='.Auth::user()->user_id.' supplier_id='.$supplier_id);
            return view('error');
        }
        $supplier = User::find($supplier_id);
        if(!$supplier)
        {
            Log::error('SupplierController/edit find() error! auth user id='.Auth::user()->user_id.' supplier_id='.$supplier_id);;
            return view('error');
        }
    ...
    public function update(Request $request)
    {
        ...
        {
            Log::error('SupplierController/update no supplier_id error! auth user id='.Auth::user()->user_id.' supplier_id='.$request->supplier_id);
            return view('error');
        }

        $result = User::where('supplier_id', $request->supplier_id)
            ->update([
                'login_id' => $request->login_id,
                'emp_no' => $request->emp_no,
                'last_name' => $request->last_name,
        ...
        if(!$result)
        {
            Log::error('SupplierController/update update() error! auth user id='.Auth::user()->user_id.' supplier_id='.$supplier_id);
            return view('error');
        }
    ...
    public function destroy(Request $request)
    {
        ...
        if(!$request->supplier_id)
        {
            Log::error('SupplierController/destroy no supplier_id error! auth user id='.Auth::user()->user_id.' supplier_id='.$supplier_id);
            return view('error');
        }
        ...
        if(!$result)
        {
            Log::error('SupplierController/destroy delete() error! auth user id='.Auth::user()->user_id.' supplier_id='.$supplier_id);
            return view('error');
        }
