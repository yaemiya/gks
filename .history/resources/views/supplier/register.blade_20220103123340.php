            ...
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <div class="mt-4">
                        <x-label value="郵便番号" />
                        <div class="flex">
                            <x-input id="ｐ_1" class="block mt-1 mr-3 w-1/3 text-xs" type="text" :value="old('ｐ_1')"
                                name="ｐ_1" maxlength="5" placeholder="必須" />
                            _
                            <x-input id="ｐ_2" class="block mt-1 mx-3 w-1/3 text-xs" type="text" :value="old('ｐ_2')"
                                name="ｐ_2" maxlength="5" placeholder="必須" />
                        </div>
                        <div id="ｐ_err" class="text-sm text-red-600"></div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex">
                            ...
                            <x-input id="ｐ_2" class="block mt-1 mx-3 w-1/3 text-xs" type="text" :value="old('ｐ_2')"
                                name="ｐ_2" maxlength="5" placeholder="必須" />
                            _
                            <x-input id="ｐ_3" class="block mt-1 ml-3 w-1/3 text-xs" type="text" :value="old('ｐ_3')"
                                name="ｐ_3" maxlength="5" placeholder="必須" />
                        </div>
                        <div id="ｐ_err" class="text-sm text-red-600"></div>
                    </div>
