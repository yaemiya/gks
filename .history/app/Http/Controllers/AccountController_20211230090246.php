...
class AccountController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Log::info('AccountController/store start!            Log::error('AccountController/store create() error!  auth user id='.Auth::user()->user_id);
);
    ...
    public function show($user_id)
    {
        ...
        if(!$user)
        {
            Log::error('AccountController/show find() error!  login user id='.Auth::user()->user_id.' user_id='.$user_id);
            return view('error');
        }
    ...
    public function edit($user_id)
    {
        ...
        if(!$user)
        {
            Log::error('AccountController/edit find() error! login user id='.Auth::user()->user_id.' user_id='.$user_id);
            return view('error');
        }
    ...
    public function update(Request $request)
    {
        ...
        if(!$user)
        {
            Log::error('AccountController/store update() error! user_id');
            return view('error');
        }
