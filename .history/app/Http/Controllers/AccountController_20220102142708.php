...
class AccountController extends Controller
{
    ...
    public function create()
    {
        ...
        if(Auth::user()->role !== '1')
        {
            Log::error('AccountController/create unauthorixed access error! auth user id='.Auth::user()->user_id);
            return view('error');
        }
    ...
    public function store(Request $request)
    {
        ...
        if(Auth::user()->role !== '1')
        {
            Log::error('AccountController/store unauthorixed access error! auth user id='.Auth::user()->user_id);
            return view('error');
        }
