...
$(function () {
  ...
  $('#register_btn').on('click', function () {
    ...
    if ($('#password_confirmation').val() === '') {
      ...
      $('#password_confirmation_err').text('パスワードと同じ値を入力してください。'); // $('#password_confirmation').val(''); // 入力パスワードの消去
    ...
    if ($('#tel_1').val() === '' || $('#tel_2').val() === '' || $('#tel_3').val() === '') {
      ...
      $('#tel_err').text('電話番号は5字以内で入力してください。');
      err_flg = 1;
    } // 権限のバリデーション
  ...
  $("ul.info_2116 li").mouseover(function () {
