...
@section('content')
    ...
    <div class="container">
        ...
        <form method="POST" action="account/edit">
            ...
            <!-- Login ID -->
            <div>
                <label for="login_id" :value="__('Login ID')" />
                <input id="login_id" class="block mt-1 w-full text-xs" type="text" :value="old('login_id')" name="login_id"
                    maxlength="16" autofocus placeholder="必須 半角英数字および「.-_」8-16字" />
                </label>
            ...
            <!-- Emp No -->
            <div>
                <label for="emp_no" value="社員番号" />
                <x-input id="emp_no" class="block mt-1 w-full text-xs" type="text" :value="old('emp_no')" name="emp_no"
                    maxlength="4" autofocus placeholder="必須 半角英数字4字" />
            ...
            <div class="mt-4 password">
                ...
                <x-input id="password" class="block mt-1 w-full text-xs" type="password" name="password" maxlength="16"
                    autocomplete="current-password" placeholder="必須 半角英数字8字以上16字以内" />
            ...
            <div class="mt-4">
                ...
                <div class="mt-4">
                    ...
                    <select id="role" class="block mt-1 w-full text-xs" type="text" name="role">
                        ...
                        <option value="1" @if (old('role') === '1') selected @endif>管理</option>
                        <option value="2" @if (old('role') === '2') selected @endif>閲覧</option>
                    </select>
                    <div id="role_err" class="text-sm text-red-600"></div>
                </div>

                <div class="flex items-center justify-end mt-6 mb-4">
                    <x-button id="register_btn">
                        {{ __('Register') }}
                    </x-button>
                </div>
        </form>
