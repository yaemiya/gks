            ...
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <div>
                        ...
                        <x-input id="supplier_name" class="block mt-1 w-full text-xs" type="text" :value="old('supplier_name')"
                            name="supplier_name" maxlength="30" autofocus placeholder="必須 30字以内" />
                    ...
                    <div class="mt-4">
                        ...
                        name="rep_name" maxlength="4" autofocus placeholder="必須 半角英数字4字" />
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-4">
                            ...
                            <select id="role" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full text-xs" type="text" name="role">
