        ...
        <div class="formContainerForPut">
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <!-- 都道府県 -->
                    <div class="mt-4">
                        <x-label for="p" value="都道府県" />

                        <x-input id="p" class="block mt-1 w-full text-xs" type="text" :value="old('p')"
                            name="p" maxlength="20" placeholder="必須" />
                        <div id="p_err" class="text-sm text-red-600"></div>
                    </div>
