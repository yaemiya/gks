...
Route::post('supplier/supplier_store', 'App\Http\Controllers\SupplierController@store');
Route::get('supplier/supplier_detail/{user_id}', 'App\Http\Controllers\SupplierController@show');
Route::get('supplier/supplier_edit/{user_id}', 'App\Http\Controllers\SupplierController@edit');
Route::post('supplier/supplier_update/{user_id}', 'App\Http\Controllers\SupplierController@update');
Route::post('supplier/supplier_delete/{user_id}', 'App\Http\Controllers\SupplierController@destroy');
