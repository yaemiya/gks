...
@section('content')
    <div class="bg">
                            ...
                            <tr class="tr">
                                <td class="registerTd">
                                    <select id="relationType"
                                        ...
                                        <option value="2" @if (old('relationType') === '2')
                                            selected
                                            @endif
                                            >工場</option>
                                        <option value="3" @if (old('relationType') === '3')
                                            selected
                                            @endif
                                            >店舗</option>
                                    </select>
        ...
        // 種別のバリデーション
        if ($('#relationType').val() === null) {
            $('#relationTypeErr').text('種別を選択してください。');
            errFlg = 1;
        } else if (!($('#relationType').val() === '2' || $('#relationType').val() === '3')) {
            $('#relationTypeErr').text('不正な選択がされています。');
            errFlg = 1;
        }
                                </td>
