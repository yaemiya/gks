            ...
            <div class="formMainForPut">
                ...
                <form method="POST" action="update">
                    ...
                    <div class="mt-4">
                        ...
                        <div>
                            <div class="flex">
                                <x-input id="tel_1" class="block mt-1 mr-3 w-1/3 text-xs" type="text" :value="old('tel_1', $user->tel_1)"
                                    name="tel_1" maxlength="5" placeholder="必須" />
                                _
                                <x-input id="tel_2" class="block mt-1 mx-3 w-1/3 text-xs" type="text" :value="old('tel_2', $user->tel_2)"
                                    name="tel_2" maxlength="5" placeholder="必須" />
                                _
                                <x-input id="tel_3" class="block mt-1 ml-3 w-1/3 text-xs" type="text" :value="old('tel_3', $user->tel_3)"
                        ...
                        <div class="mt-4">
                            ...
                            <select id="role" class="block mt-1 w-full text-xs" type="text" name="role">
                                ...
                                <option value="1" @if (old('role', , $user->role) === '1')
                                    ...
                                    @endif
                                    >管理</option>
                                <option value="2" @if (old('role', $user->) === '2')
                                    selected
                                    @endif
                                    >閲覧</option>
                            </select>
                        ...
                        <div class="text-right">
                            <button id="updateBtn" class="putBtn btn-blue">更新</button>
                        </div>
                </form>
            </div>
        </div>
