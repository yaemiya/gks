...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        {
            Log::error($func . ':Supplier::create() error! auth user_id='.Auth::user()->user_id.' supplier_name='.$request->supplierName.' rep_name='.$request->repName.' address_id='.$address->id.' business_kind='.$request->building);
            $message = __('messages.err.dbErr');
            DB::rollBack();
            return view('error', compact('message'));
        }
