            ...
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <div class="mt-4">
                        <x-label value="郵便番号" />
                        <div class="flex">
                            <x-input id="_1" class="block mt-1 mr-3 w-1/3 text-xs" type="text" :value="old('_1')"
                                name="_1" maxlength="5" placeholder="必須" />
                            _
                            <x-input id="_2" class="block mt-1 mx-3 w-1/3 text-xs" type="text" :value="old('_2')"
                                name="_2" maxlength="5" placeholder="必須" />
                        </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex">
                            ...
                            <x-input id="_2" class="block mt-1 mx-3 w-1/3 text-xs" type="text" :value="old('_2')"
                                name="_2" maxlength="5" placeholder="必須" />
                            _
                            <x-input id="_3" class="block mt-1 ml-3 w-1/3 text-xs" type="text" :value="old('_3')"
                                name="_3" maxlength="5" placeholder="必須" />
                        </div>
                        <div id="_err" class="text-sm text-red-600"></div>
                    </div>
