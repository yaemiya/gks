                ...
                <div class="title ">ユーザー編集</div>
                    ...
                    <form method="POST" action="store">
                        ...
                        <div class="mt-4">
                            ...
                            <x-input id="first_name" class="block mt-1 w-full text-xs" type="text"
                                :value="old('first_name')" name="first_name" maxlength="20" placeholder="必須" />
                        ...
                        <div class="mt-4">
                            ...
                            <div>
                                <div class="flex">
                                    <x-input id="tel_1" class="block mt-1 mr-3 w-1/3 text-xs" type="text"
                                        :value="old('tel_1')" name="tel_1" maxlength="5" placeholder="必須" />
                                    _
                                    <x-input id="tel_2" class="block mt-1 mx-3 w-1/3 text-xs" type="text"
                                        :value="old('tel_2')" name="tel_2" maxlength="5" placeholder="必須" />
                                    _
                                    <x-input id="tel_3" class="block mt-1 ml-3 w-1/3 text-xs" type="text"
                                        :value="old('tel_3')" name="tel_3" maxlength="5" placeholder="必須" />
                                </div>
