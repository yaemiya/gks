        ...
        <div class="formMain">
            ...
            <table class="table">
                ...
                <tr class="tr">
                    ...
                    <td class="td px-4">{{ $user->login_id }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">社員番号</th>
                ...
                <tr class="tr">
                    <th class="th">姓</th>
                    <td class="td px-4">{{ $user->last_name }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">名</th>
                    <td class="td px-4">{{ $user->first_name }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">メールアドレス</th>
                    <td class="td px-4">{{ $user->email }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">電話番号</th>
                    <td class="td px-4">{{ $user->tel }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">権限</th>
                    @if ($user->role === '1')
                        <td class="td px-4">管理</td>
                    @else
                        <td class="td px-4">閲覧</td>
                    @endif
                </tr>
            </table>
        </div>
