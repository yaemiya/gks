...
Route::get('supplier/supplier_create', 'App\Http\Controllers\SupplierController@create');
Route::post('supplier/supplier-store', 'App\Http\Controllers\SupplierController@store');
Route::get('supplier/supplier-detail/{user_id}', 'App\Http\Controllers\SupplierController@show');
Route::get('supplier/supplier-edit/{user_id}', 'App\Http\Controllers\SupplierController@edit');
Route::post('supplier/supplier-update/{user_id}', 'App\Http\Controllers\SupplierController@update');
Route::post('supplier/supplier-delete/{user_id}', 'App\Http\Controllers\SupplierController@destroy');
