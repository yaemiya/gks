                            ...
                            <tr class="tr">
                                <td class="registerTd">
                                    <select id="businessKind
                                        ...
                                        <option value="2" @if (old('businessKind
                                                ') === '2')
                                            selected
                                            @endif
                                            >工場</option>
                                        <option value="3" @if (old('businessKind
                                                ') === '3')
                                            selected
                                            @endif
                                            >店舗</option>
                                    </select>
                                    <div id="businessKindErr
    ...
    <section id="selectModalArea" class="modalArea">
        ...
        <div class="selectModalWrapper">
            <div class="modalContent">
                ...
                <div>
                    <div class="flex place-content-center mt-6 h-8 min-w-full">
                    ...
                    <div class="text-center border border-black mt-8">店舗（ID）</div>
                    <div id="shopList" class="border border-black">
                        <ul class="divide-y divide-gray-200">
                            @foreach ($shops as $shop)
                                <li><a href=#>{{ $shop->shop_name }}（{{ $shop->shop_id }}）</a></li>
                            @endforeach
                        </ul>
                    </div>
                </div>
