            ...
            <div class="formMainForPut">
                ...
                <form method="POST" action="update">
                    ...
                    <div class="mt-4">
                        ...
                        <div>
                            <div class="flex">
                                <x-input id="tel_1" class="block mt-1 w-full text-xs" type="text" :value="old('tel', $user->tel)"
                                    name="tel" maxlength="5" placeholder="必須" />
                            </div>
                        ...
                        <div class="mt-4">
                            ...
                            <select id="role" class="block mt-1 w-full text-xs border-opacity-50" type="text" name="role">
