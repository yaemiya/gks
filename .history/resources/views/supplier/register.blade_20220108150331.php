                ...
                <form method="POST" action="store">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex">
                            ...
                            <button type="button" id="postal_code_btn" class="btn-black addressSearchBtn" on="AjaxZip3.zip2addr('postal_code_1', 'postal_code_2', 'prefecture', 'address');">住所検索</button>
                        </div>
