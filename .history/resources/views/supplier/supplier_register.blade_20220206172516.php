                        ...
                        <table class="registerTable text-xs">
                            ...
                            <tr class="tr">
                                ...
                                <td id="selectBox" class="td bg-white">
                                    ...
                                    <input type="text" id="modalSelected" class="hidden pl-4 shadow-sm border-none focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block w-full text-xs" val="" readonly>
