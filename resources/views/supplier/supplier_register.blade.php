                        ...
                        <table class="registerTable text-xs">
                            ...
                            <tr class="tr">
                                ...
                                <td id="selectBox" class="td bg-white">
                                    ...
                                    <span type="text" id="modalSelected" class="pl-4 border-none inline-block w-full text-xs">{{ old('shopData') }}</span>
                                    <input type="hidden" id="selectedId" name="shopId" value="{{ old('shopId') }}">
                                    <input type="hidden" id="selectedData" name="shopData" value="{{ old('shopData') }}">
                                </td>
                            </tr>
                        </table>
