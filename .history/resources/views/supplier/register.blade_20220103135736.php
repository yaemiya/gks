        ...
        <div class="formContainerForPut">
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <!-- 都道府県 -->
                    <div class="mt-4">
                        <x-label for="pre" value="都道府県" />

                        <x-input id="pre" class="block mt-1 w-full text-xs" type="text" :value="old('pre')"
                            name="pre" maxlength="20" placeholder="必須" />
                        <div id="pre_err" class="text-sm text-red-600"></div>
                    </div>
