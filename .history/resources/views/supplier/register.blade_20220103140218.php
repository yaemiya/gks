        ...
        <div class="formContainerForPut">
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <!-- 住所 -->
                    <div class="mt-4">
                        <x-label for="あ" value="住所" />

                        <x-input id="あ" class="block mt-1 w-full text-xs" type="text" :value="old('あ')"
                            name="あ" maxlength="20" placeholder="必須" />
                        <div id="あ_err" class="text-sm text-red-600"></div>
                    </div>
