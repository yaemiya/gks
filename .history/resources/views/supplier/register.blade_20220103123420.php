            ...
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <div class="mt-4">
                        <x-label value="郵便番号" />
                        <div class="flex">
                            <x-input id="__1" class="block mt-1 mr-3 w-1/3 text-xs" type="text" :value="old('__1')"
                                name="__1" maxlength="5" placeholder="必須" />
                            _
                            <x-input id="__2" class="block mt-1 mx-3 w-1/3 text-xs" type="text" :value="old('__2')"
                                name="__2" maxlength="5" placeholder="必須" />
                        </div>
                        <div id="__err" class="text-sm text-red-600"></div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex">
                            ...
                            <x-input id="__2" class="block mt-1 mx-3 w-1/3 text-xs" type="text" :value="old('__2')"
                                name="__2" maxlength="5" placeholder="必須" />
                            _
                            <x-input id="__3" class="block mt-1 ml-3 w-1/3 text-xs" type="text" :value="old('__3')"
                                name="__3" maxlength="5" placeholder="必須" />
                        </div>
                        <div id="__err" class="text-sm text-red-600"></div>
                    </div>
