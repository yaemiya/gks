        ...
        <div class="formContainerForPut">
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <!-- 番地 -->
                    <div class="mt-4">
                        <x-label for="hou" value="番地" />
                        <x-input id="hou" class="block mt-1 w-full text-xs" type="text" :value="old('hou')"
                            name="hou" maxlength="20" placeholder="必須" />
                        <div id="houErr" class="text-sm text-red-600"></div>
                    </div>
