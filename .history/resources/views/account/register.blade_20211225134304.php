...
<x-app-layout>
    <x-auth-card-register>
        <p class="text-xs">アカウント > 新規登録</p>
        <h1 class="center text-center font-bold mt-4 mb-6">ユーザー新規登録</h1>
        ...
        <form method="POST" action="store">
            ...
            <div class="mt-4">
                ...
                <div>
                    <div class="flex">
                        <x-input id="tel_1"
                        class="block mt-1 mr-3 w-1/3 text-xs"
                        type="text"
                        :value="old('tel_1')"
                        name="tel_1"
                        maxlength="5"
                    ...
                    _
                    <x-input id="tel_2"
                    class="block mt-1 mx-3 w-1/3 text-xs"
                        type="text"
                        :value="old('tel_2')"
                        name="tel_2"
                        maxlength="5"
                    ...
                    _
                    <x-input id="tel_3"
                        class="block mt-1 ml-3 w-1/3 text-xs"
                        type="text"
                        :value="old('tel_3')"
                        name="tel_3"
                        maxlength="5"
