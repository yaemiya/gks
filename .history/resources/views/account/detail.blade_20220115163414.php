        ...
        <div class="formMain">
            ...
            <table class="table">
                <tr class="tr">
                    ...
                    <td class="t">{{ $user->user_id }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">ログインID</th>
                    <td class="t">{{ $user->login_id }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">社員番号</th>
                    <td class="t">{{ $user->emp_no }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">姓</th>
                    <td class="t">{{ $user->last_name }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">名</th>
                    <td class="t">{{ $user->first_name }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">メールアドレス</th>
                    <td class="t">{{ $user->email }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">電話番号</th>
                    <td class="t">{{ $user->tel }}</td>
                </tr>
                <tr class="tr">
                    <th class="th">権限</th>
                    @if ($user->role === '1')
