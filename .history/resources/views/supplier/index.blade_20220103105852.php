                ...
                <tbody class="tbody">
                    @foreach ($suppliers as $supplier)
                        <tr class="tr">
                            ...
                            <td class="td"><a
                                    href="account/detail/{{ $supplier->supplier_id }}">{{ $supplier->supplier_name . ' ' . $supplier->first_name }}</a>
                            </td>
                            @if ($supplier->role === '1')
                                <td class="td" id="role" data-role="{{ $supplier->role }}">管理</td>
                            @else
                                <td class="td" id="role" data-role="{{ $supplier->role }}">閲覧</td>
                            @endif
                        </tr>
                    @endforeach
                </tbody>
