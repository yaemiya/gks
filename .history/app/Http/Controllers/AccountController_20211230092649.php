...
class AccountController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if(!$result)
        {
            Log::error('AccountController/store update() error! auth user id='.Auth::user()->user_id.' user_id='.$user_id);
            return view('error');
        }
    ...
    public function delete(Request $request)
    {
        ...
        if(!$result)
        {
            Log::error('AccountController/store delete() error! auth user id='.Auth::user()->user_id.' user_id='.$user_id);
            return view('error');
        }
