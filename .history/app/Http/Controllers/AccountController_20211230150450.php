...
class AccountController extends Controller
{
    ...
    public function show($user_id)
    {
        ...
        if(!$request->user_id)
        {
            Log::error('AccountController/ no user_id error! auth user id='.Auth::user()->user_id.' user_id='.$user_id);
            return view('error');
        }
    ...
    public function update(Request $request)
    {
        ...
        if(!$request->user_id)
        {
            Log::error('AccountController/update no user_id error! auth user id='.Auth::user()->user_id.' user_id='.$user_id);
            return view('error');
        }
