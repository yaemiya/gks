            ...
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <div>
                        ...
                        <input id="supplierName" class="block mt-1 w-full text-xs" type="text" :value="old('supplierName')"
                            name="supplierName" maxlength="30" autofocus placeholder="必須" />
                        <div id="supplierName_err" class="text-sm text-red-600"></div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div id="repName_err" class="text-sm text-red-600"></div>
                    </div>
                    ...
                    <div class="mt-4">
                        <x-label value="郵便番号" />
                        <div class="flex">
                            <x-input id="postalCode_1" class="block mt-1 mr-3 w-1/4 text-xs" type="text"
                                :value="old('postalCode_1')" name="postalCode_1" maxlength="3" placeholder="必須" />
                            _
                            <x-input id="postalCode_2" class="block mt-1 mx-3 w-1/4 text-xs" type="text"
                                :value="old('postalCode_2')" name="postalCode_2" maxlength="4" placeholder="必須" />
                            <button type="button" id="postalCode_btn" class="btn-black addressSearchBtn"
                                onClick="AjaxZip3.zip2addr('postalCode_1', 'postalCode_2', 'prefecture', 'address');">住所検索</button>
                        </div>
                        <div id="postalCode_err" class="text-sm text-red-600"></div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <table class="registerTable text-xs">
                            ...
                            <tr class="tr">
                                ...
                                <td id="openSelectBox" class="td bg-white">
                                    <select id="plantList"
                                        class="pl-4 shadow-sm border-none focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block w-full text-xs"
                                        type="text" name="role">
                                        <option value="" class="hidden" disabled selected>選択してください</option>
    ...
    <section id="selectModalArea" class="modalArea">
        ...
        <div class="selectModalWrapper">
            <div class="modalContent">
                ...
                <div class="flex place-content-center mt-6 h-8">
                    <button id="searchrBtn" class="searchBtn btn-black h-8 align-middle">検索</button>
                    <input type="search" id="searchBox" class="searchBox w-60" placeholder="キーワードを入力">
                </div>
                <div id="shopList">
                    <ul>
                        {{-- @foreach ($plants as $plant)
                            <li><a href=#><?= $plant->plant_name ?></a></li>
                        @endforeach --}}
                    </ul>
                </div>
