$(function () {
    ...
    $('#registerBtn').on('click', function () {
        ...
        if ($('#tel_1').val() === '' || $('#tel_2').val() === '' || $('#tel_3').val() === '') {
            ...
            err_flg = 1;
        } else if (($('#tel_1').val()+$('#tel_2').val()+$('#tel_3').val()).length > 11 || $('#tel_1').val()+$('#tel_2').val()+$('#tel_3').val()).length <) {
            $('#tel_err').text('電話番号の桁数は10桁か11桁で入力してください。');
            err_flg = 1;
        }
        // 権限のバリデーション
        if ($('#role').val() === null) {
