            ...
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <div class="mt-4">
                        <x-label value="郵便番号" />
                        <div class="flex">
                            <x-input id="postal_1" class="block mt-1 mr-3 w-1/3 text-xs" type="text" :value="old('postal_1')"
                                name="postal_1" maxlength="5" placeholder="必須" />
                            _
                            <x-input id="postal_2" class="block mt-1 mx-3 w-1/3 text-xs" type="text" :value="old('postal_2')"
                                name="postal_2" maxlength="5" placeholder="必須" />
                        </div>
                        <div id="postal_err" class="text-sm text-red-600"></div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex">
                            ...
                            <x-input id="postal_2" class="block mt-1 mx-3 w-1/3 text-xs" type="text" :value="old('postal_2')"
                                name="postal_2" maxlength="5" placeholder="必須" />
                            _
                            <x-input id="postal_3" class="block mt-1 ml-3 w-1/3 text-xs" type="text" :value="old('postal_3')"
                                name="postal_3" maxlength="5" placeholder="必須" />
                        </div>
                        <div id="postal_err" class="text-sm text-red-600"></div>
                    </div>
