...
class SupplierController extends Controller
{
    ...
    public function show($supplier_id)
    {
        ...
        return view('supplier/supplier-detail', compact('user'));
    }
    ...
    public function create()
    {
        ...
        return view('supplier.supplier-register', compact('plants', 'shops'));
    }
 ...
 // 仕入業者登録処理
    ...
    public function edit($supplier_id)
    {
        ...
        return view('supplier/supplier-edit', compact('user'));
    }
