            ...
            <div class="formMainForPut">
                ...
                <form method="POST" action="store">
                    ...
                    <div class="mt-4">
                        <x-label value="郵便番号" />
                        <div class="flex">
                            <x-input id="postalCodeErr" class="block mt-1 mr-3 w-1/4 text-xs" type="text"
                                :value="old('postalCodeErr')" name="postalCode_1" maxlength="3" placeholder="必須" />
                            _
                    ...
                    <div class="mt-4">
                        ...
                        <div id="house_numErr" class="text-sm text-red-600"></div>
                    </div>
